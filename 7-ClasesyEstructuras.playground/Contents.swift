...
//Init = crean un método init por defecto con tantos parámetros como propiedades tenga. ¡Ojo!, porque en el momento que nosotros creemos un init, el que se crea por defecto desaparece y tendríamos que añadirlo manualmente. si en un Struct añades los inits dentro de una extensión, el init por defecto no se destruye y no tenemos que añadirlo de nuevo. las estructuras no tienen inits de conveniencia.
...
let user = User(name: <#T##String#>, city: <#T##String#>)
let singer = Singer()
...
var chatDatabase = Database(name: "Chat")
...
remoteDatabase.name = "💻 SwiftBetaDatabase"
...
var timCook = Coworker(name: "Tim Cook")
