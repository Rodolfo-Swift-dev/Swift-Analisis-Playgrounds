//Type casting
//Error frecuente: confundir casting con conversión. as? no transforma "123" en
//Int; para convertir el contenido se usa Int("123").
...
let nacho = Human(name: "Nacho")
let martin = Human(name: "Martin")
...
func findNemoSafely(from animals: [Any]) {
  for animal in animals {
