//Extensiones
//Error frecuente: intentar agregar propiedades almacenadas. Una extensión sí
//puede aportar propiedades computadas, métodos, inicializadores y conformidades.
...
anotherUser.update(name: "RodDev")
anotherUser.reset()
var anotherUser1 = User1(name: "Rodolfo")
anotherUser1.update(name: "RodDev")
anotherUser1.reset()
...
extension User2 {
  ...
  static var newName: String { return "Nacho-Martin" }
}
...
let newUser = User4(
  ...
  twitter: "Rod-Dev")
print(newUser.name, newUser.youtubeChannel, newUser.twitter)
...
extension User4 {
  init(
    ...
    self.init(
      name: userName, youtubeChannel: youtubeChannel,
      twitter: twitter)
  }
}
