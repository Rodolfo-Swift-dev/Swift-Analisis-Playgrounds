//Herencia
//Error frecuente: elegir herencia solo para compartir código. Debe expresar una
//relación real; para combinar capacidades suele ser preferible la composición.
...
let chihuahuaWithFinalMethod = Chihuahua4(
  legs: 4,
  name: "Toby",
  age: 2
)
chihuahuaWithFinalMethod.eat()
...
let chihuahuaWithFinalProperty = Chihuahua5(
  name: "Luna",
  age: 3,
  legs: 4
)
print(chihuahuaWithFinalProperty.description)
