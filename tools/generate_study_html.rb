...
EXAMPLES_BY_CHAPTER = {
  0 => [
    %q{print("Hello, Swift")},
    %q{// This comment is not executed},
    "/* Multi-line\n   comment */",
    %q{let pi = 3.14159},
    "var score = 0\nscore += 1",
    %q{let age: Int = 36},
    %q{let language = "Swift" // Inferred String},
    %q{let count: Int = 3},
    %q{let opacity: Float = 0.5},
    %q{let price: Double = 19.99},
    %q{let greeting: String = "Hello"},
  ...
  3 => [
    ...
    %q{let count = nickname!.count // Traps if nickname is nil},
    %q{let displayName = nickname ?? "No name"},
    %q{let firstLetter = nickname?.first},
    "if nickname != nil {\n    print(\"A value exists, but it is still String?\")\n}",
  ...
  4 => [
    ...
    %q{if names.isEmpty { print("No names") }},
    ...
    %q{ages["Luis"] = 31},
    %q{ages["Ana"] = nil // Removes the entry},
  ...
  5 => [
    ...
    "switch number {\ncase 0: print(\"Zero\")\ndefault: print(\"Other\")\n}",
    "switch number {\ncase 0: print(\"Zero\")\ndefault: break\n}",
    "switch age {\ncase let value where value >= 18: print(\"Adult\")\ndefault: print(\"Minor\")\n}",
    "for number in numbers {\n    if number < 0 { break }\n}",
    "for name in names {\n    print(name)\n}",
    "for number in numbers where number.isMultiple(of: 2) {\n    print(number)\n}",
    %q{for _ in 1...3 { print("Hello") }},
    "while attempts < 3 {\n    attempts += 1\n}",
    "repeat {\n    attempts += 1\n} while attempts < 3"
  ],
  6 => [
  ...
  7 => [
    ...
    "class User {\n    init(name: String) { }\n    convenience init() { self.init(name: \"Guest\") }\n}",
    "class Connection {\n    deinit { print(\"Connection released\") }\n}",
  ...
  9 => [
    %q{struct User { var name: String }},
    %q{struct AppSettings { @MainActor static var language = "en" }},
    ...
    "var score = 0 {\n    didSet { print(\"Current: \\(score)\") }\n}",
    %q{didSet { print("Previous: \(oldValue)") }},
  ...
  10 => [
    ...
    %q{let double = { (value: Int) -> Int in value * 2 }},
    %q{let completion: () -> Void = { print("Done") }},
  ...
  11 => [
    ...
    "switch direction {\ncase .north: break\ncase .south, .east, .west: print(\"Other\")\n}",
    "switch direction {\ncase .north: print(\"North\")\ndefault: print(\"Other\")\n}",
  ...
  12 => [
    ...
    "class Dog: Animal {\n    override var description: String { \"Dog\" }\n}",
    "class Animal { class func category() -> String { \"Animal\" } }\nclass Dog: Animal { override class func category() -> String { \"Dog\" } }",
  ...
  15 => [
    ...
    "extension User {\n    static func guest() -> User { User(name: \"Guest\") }\n}",
    "extension Rectangle {\n    var area: Double { width * height }\n}",
    "extension User {\n    init() { self.init(name: \"Guest\") }\n}",
  ...
  17 => [
    ...
    "do { try save() }\ncatch DatabaseError.userExists { print(\"Already exists\") }",
    "do { try save() }\ncatch let error { print(error) }",
    %q{let user = try? loadUser() // User?},
    %q{let user = try! loadBundledUser() // Traps if it throws},
    %q{func save() throws(DatabaseError) { throw .invalidName }},
    "let file = openFile()\ndefer { file.close() }\ntry process(file)",
    "func loadProfile() throws -> Profile {\n    try repository.fetchProfile()\n}"
  ],
  18 => [
    %q{if item is Movie { print("It is a movie") }},
    %q{let animal: Animal = dog as Animal},
    "if let dog = animal as? Dog {\n    dog.bark()\n}",
    %q{let dog = animal as! Dog // Traps if it is not a Dog}
  ],
  19 => [
    %q{let status = isConnected ? "Online" : "Offline"},
    %q{let access = age >= 18 ? "Allowed" : "Denied"},
